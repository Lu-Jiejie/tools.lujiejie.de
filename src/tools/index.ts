...
export type ToolCategory = 'favorites' | 'convert' | 'generate' | 'dev' | 'text' | 'design' | 'utility'
...
export const CATEGORY_ORDER: ToolCategory[] = ['convert', 'generate', 'dev', 'text', 'design', 'utility']
